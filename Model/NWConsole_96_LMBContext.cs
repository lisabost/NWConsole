...
{
    public partial class NWConsole_96_LMBContext : DbContext
    {
        public NWConsole_96_LMBContext()
        {
        }

        public NWConsole_96_LMBContext(DbContextOptions<NWConsole_96_LMBContext> options)
            : base(options)
        {
        }
